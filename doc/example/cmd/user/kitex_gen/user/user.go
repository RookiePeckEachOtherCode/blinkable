...
func NewUserLoginRequests() *UserLoginRequests {
	return &UserLoginRequests{}
}

func (p *UserLoginRequests) InitDefault() {
	*p = UserLoginRequests{}
}

func (p *UserLoginRequests) GetUsername() (v string) {
	return p.Username
}

func (p *UserLoginRequests) GetPassword() (v string) {
	return p.Password
}
func (p *UserLoginRequests) SetUsername(val string) {
	p.Username = val
}
func (p *UserLoginRequests) SetPassword(val string) {
	p.Password = val
}

var fieldIDToName_UserLoginRequests = map[int16]string{
	1: "username",
	2: "password",
}

func (p *UserLoginRequests) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserLoginRequests[fieldId]), err)
SkipFieldError:
...
func (p *UserLoginRequests) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UserLoginRequests) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Password = v
...
func (p *UserLoginRequests) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UserLoginRequests"); err != nil {
...
func (p *UserLoginRequests) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *UserLoginRequests) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *UserLoginRequests) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserLoginRequests(%+v)", *p)
}

func (p *UserLoginRequests) DeepEqual(ano *UserLoginRequests) bool {
	if p == ano {
		return true
...
func (p *UserLoginRequests) Field1DeepEqual(src string) bool {
...
func (p *UserLoginRequests) Field2DeepEqual(src string) bool {
...
func (p *UserLoginResponse) GetMsg() (v string) {
	return p.Msg
}
func (p *UserLoginResponse) SetMsg(val string) {
	p.Msg = val
}
...
type UserService interface {
	UserLogin(ctx context.Context, req *UserLoginRequests) (r *UserLoginResponse, err error)
}
...
func (p *UserServiceClient) UserLogin(ctx context.Context, req *UserLoginRequests) (r *UserLoginResponse, err error) {
...
type UserServiceUserLoginArgs struct {
	Req *UserLoginRequests `thrift:"req,1" frugal:"1,default,UserLoginRequests" json:"req"`
}
...
var UserServiceUserLoginArgs_Req_DEFAULT *UserLoginRequests

func (p *UserServiceUserLoginArgs) GetReq() (v *UserLoginRequests) {
	if !p.IsSetReq() {
		return UserServiceUserLoginArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceUserLoginArgs) SetReq(val *UserLoginRequests) {
	p.Req = val
}
...
func (p *UserServiceUserLoginArgs) Field1DeepEqual(src *UserLoginRequests) bool {
