...
func newGuestbook(db *gorm.DB, opts ...gen.DOOption) guestbook {
	...
	_guestbook.ID = field.NewInt32(tableName, "id")
	_guestbook.CreateAt = field.NewTime(tableName, "create_at")
	_guestbook.UpdateAt = field.NewTime(tableName, "update_at")
	_guestbook.AdminID = field.NewUint32(tableName, "admin_id")
	_guestbook.Context = field.NewString(tableName, "context")
	_guestbook.UserID = field.NewUint32(tableName, "user_id")
...
func (g *guestbook) updateTableName(table string) *guestbook {
	...
	g.AdminID = field.NewUint32(table, "admin_id")
...
func (g guestbookDo) FilterWithNameAndRole(name string, role string) (result []model.Guestbook, err error) {
	...
	generateSQL.WriteString("SELECT * FROM guestbooks WHERE name = ? ")
	if role != "" {
